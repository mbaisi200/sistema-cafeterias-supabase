...
export default function CategoriasPage() {
  const { categorias, loading, adicionarCategoria, excluirCategoria, recarregar } = useCategorias();
  ...
  const [excluindoCategoria, setExcluindoCategoria] = useState<any>(null);
        ...
        <div className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-muted-foreground">Organize os produtos do cardápio por categorias</p>
            </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">As categorias são exibidas no PDV na ordem de criação.</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <AlertDialog open={!!excluindoCategoria} onOpenChange={() => setExcluindoCategoria(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                Tem certeza que deseja excluir a categoria <strong>{excluindoCategoria?.nome}</strong>?
                <br />
                <span className="text-amber-600">Os produtos desta categoria ficarão sem categoria.</span>
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
