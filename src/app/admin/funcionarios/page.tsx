...
export default function FuncionariosPage() {
  const { funcionarios, loading, adicionarFuncionario, atualizarFuncionario, excluirFuncionario, recarregar } = useFuncionarios();
  ...
  const [excluindoFuncionario, setExcluindoFuncionario] = useState<Funcionario | null>(null);
  ...
  return (
    <ProtectedRoute allowedRoles={['admin']}>
      ...
      >
              ...
              <DialogHeader>
                ...
                <DialogDescription>
                  {editandoFuncionario 
                    ...
                    : 'Cadastre um funcionário com PIN e senha de acesso.'
                  }
                </DialogDescription>
              </DialogHeader>
              <form onSubmit={handleSalvar}>
                <div className="space-y-4 py-4">
                  ...
                  <div className="p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <Label htmlFor="senha" className="flex items-center gap-2 text-blue-800 mb-2">
                    ...
                    <p className="text-xs text-blue-600 mt-2">
                      {editandoFuncionario 
                        ...
                        : 'Esta senha será usada junto com o PIN para login.'
                      }
                    </p>
                  </div>
                          ...
                          <TableCell className="text-right">
                            <div className="flex items-center justify-end gap-1">
                              ...
                              <Button
                                ...
                                size="icon"
                                className="h-8 w-8"
                                onClick={() => setExcluindoFuncionario(func)}
                              >
        ...
        <AlertDialog open={!!excluindoFuncionario} onOpenChange={() => setExcluindoFuncionario(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              <AlertDialogTitle>Excluir Funcionário</AlertDialogTitle>
              <AlertDialogDescription>
                Tem certeza que deseja excluir o funcionário <strong>{excluindoFuncionario?.nome}</strong>?
                <br />
                <span className="text-amber-600">Esta ação não pode ser desfeita.</span>
              </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
              ...
              <AlertDialogAction 
                onClick={async () => {
                  if (excluindoFuncionario) {
                    try {
                      await excluirFuncionario(excluindoFuncionario.id);
                      toast({ title: 'Funcionário excluído!' });
                      recarregar();
                    } catch (error) {
                      toast({ variant: 'destructive', title: 'Erro ao excluir funcionário' });
                    }
                    setExcluindoFuncionario(null);
                  }
                }}
