...
export function useProdutos() {
  ...
  return { produtos, loading, adicionarProduto, atualizarProduto, excluirProduto, recarregar: carregarDados };
}
...
export function useCategorias() {
  ...
  return { categorias, loading, adicionarCategoria, atualizarCategoria, excluirCategoria, recarregar: carregarDados };
}
...
export function useMesas() {
  ...
  return { mesas, loading, adicionarMesa, atualizarMesa, excluirMesa, recarregar: carregarDados };
}
...
export function useFuncionarios() {
  ...
  return { funcionarios, loading, adicionarFuncionario, atualizarFuncionario, excluirFuncionario, recarregar: carregarDados };
}
