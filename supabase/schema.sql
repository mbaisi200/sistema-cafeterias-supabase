...
CREATE TABLE IF NOT EXISTS empresas (
  ...
  estado VARCHAR(2),
  cep VARCHAR(10),
  endereco TEXT, -- Campo adicional para endereço completo
...
-- =====================================================
-- 18. TABELA: PEDIDOS_TEMP (para pedidos temporários de mesa/delivery)
-- =====================================================
...
CREATE INDEX idx_pedidos_temp_empresa ON pedidos_temp(empresa_id);
CREATE INDEX idx_pedidos_temp_mesa ON pedidos_temp(mesa_id);
CREATE INDEX idx_pedidos_temp_delivery ON pedidos_temp(delivery_id);
CREATE INDEX idx_pedidos_temp_tipo ON pedidos_temp(tipo_venda);
...
CREATE TRIGGER update_pedidos_temp_updated_at BEFORE UPDATE ON pedidos_temp FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
